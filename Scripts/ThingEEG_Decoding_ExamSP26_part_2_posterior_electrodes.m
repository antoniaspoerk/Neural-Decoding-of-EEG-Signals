...
% Posterior electrodes (Iz excluded - not found in the electrode structure)
posterior_electrodes=[16,17,18,45,46,47,48,49];
data2=data2(:,posterior_electrodes,:);
...
title('Animal vs Non-animal decoding - Subject 0 - Posterior Electrodes only');
legend({'95% CI permutation', 'Permutation mean', 'Decoding accuracy'});

%% Save results
save('DA_part2_posterior.mat', 'DA');
save('DA_sh_part2_posterior.mat', 'DA_perm');
