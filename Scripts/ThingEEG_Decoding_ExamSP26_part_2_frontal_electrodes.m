...
frontal_electrodes=[1,31,32,33,34,60,61];
data2=data2(:,frontal_electrodes,:);
...
title('Animal vs Non-animal decoding - Subject 0 - Frontal Electrodes');
legend({'95% CI permutation', 'Permutation mean', 'Decoding accuracy'});

%% Save results
save('DA_part2_frontal.mat', 'DA');
save('DA_sh_part2_frontal.mat', 'DA_perm');
